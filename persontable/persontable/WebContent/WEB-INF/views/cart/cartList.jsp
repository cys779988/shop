		...
		<div class="container">
			...
			<section id="content">
				<ul>
					<li>
						...
						<div class="submit-button text-right">
							<div class="delBtn">
								<button type="button" class="selectDelete_btn btn hvr-hover">선택
									삭제</button>
								<script>
									$(".selectDelete_btn")
											.click(
								...
								<div class="row">
									...
									<div class="ingInfo" style="margin-left: 20px;">
										...
										<div class="submit-button text-right">
											<div class="delete">
												<button type="button"
													class="btn hvr-hover delete_${cartList.cartNum}_btn"
				...
				<div class="listResult">
					...
					<div class="orderOpne">
						<button type="button" class="orderOpne_btn btn hvr-hover">주문
							정보 입력</button>
						<script>
				...
				<div class="orderInfo">
					<form role="form" method="post" autocomplete="off">
						...
						<div class="inputArea">
							<label for="addr1">우편번호</label> <input type="text" id="zip"
						...
						<div class="submit-button text-center">
							<button type="submit" onclick = "order" class="btn hvr-hover">주문</button>
